...
require_once NCWM_PLUGIN_DIR . '/includes/url-redirects-table.php';
$list_table = new NCWM_Url_Redirect_Table();
...
<div class="wrap">
    ...
    <p>You need to enable this feature in Next-Cart Migration > Settings for the redirects to work</p>
